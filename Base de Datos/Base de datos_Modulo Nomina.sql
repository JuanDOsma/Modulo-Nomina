...
CREATE TABLE TIPO_HORA_EXTRA(
    ID_TIPO_HORA_EXTRA SMALLINT PRIMARY KEY,
    DESCRIPCION_HE VARCHAR(60) NOT NULL
);

CREATE TABLE HORA_EXTRA(
    ID_HORA_EXTRA SERIAL PRIMARY KEY,
    NUM_HORA_EXTRA SMALLINT NOT NULL,
    ID_TIPO_HORA_EXTRA SMALLINT NOT NULL,
    FOREIGN KEY (ID_TIPO_HORA_EXTRA)
        REFERENCES TIPO_HORA_EXTRA (ID_TIPO_HORA_EXTRA)
);

CREATE TABLE HORA_EXTRA_EMPLEADO(
    ID_HORA_EXTRA SMALLINT NOT NULL,
    ID_EMPLEADO INT NOT NULL,
    FOREIGN KEY (ID_HORA_EXTRA)
        REFERENCES HORA_EXTRA (ID_HORA_EXTRA),
    FOREIGN KEY (ID_EMPLEADO)
        REFERENCES EMPLEADO (ID_EMPLEADO),
    PRIMARY KEY (ID_EMPLEADO,ID_HORA_EXTRA)
);
