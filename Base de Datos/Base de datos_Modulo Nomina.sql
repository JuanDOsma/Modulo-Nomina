...
CREATE TABLE DEPENDENCIA(
    ID_DEPENDENCIA SMALLINT PRIMARY KEY,
    DESCRIPCION_DEPEND VARCHAR(40) NOT NULL
);

CREATE TABLE PENSION(
    ID_PENSION SMALLINT PRIMARY KEY ,
    DESCRIPCION_PNSION VARCHAR(60) NOT NULL
);

CREATE TABLE EPS(
    ID_EPS SMALLINT PRIMARY KEY,
    DESCRIPCION_EPS VARCHAR(60) NOT NULL
);

CREATE TABLE ARL(
    ID_ARL SMALLINT PRIMARY KEY,
...
CREATE TABLE AUSENCIA(
    ID_AUSENCIA MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE NOVEDAD(
    ID_NOVEDAD MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
    ID_EMPLEADO INT NOT NULL,
    ID_TIPO_NOVEDAD SMALLINT NOT NULL,
    ID_AUSENCIA MEDIUMINT NOT NULL,
    FOREIGN KEY (ID_EMPLEADO)
        REFERENCES EMPLEADO (ID_EMPLEADO),
